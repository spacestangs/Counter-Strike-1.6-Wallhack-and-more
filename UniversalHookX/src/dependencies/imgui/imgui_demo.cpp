...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (!ImGui::Begin("Wellcome to AlexTazis hack", p_open, window_flags))
    {
    ...
    ImGui::Text("Space says Hello! (%s) (%d)", IMGUI_VERSION, IMGUI_VERSION_NUM);
    ImGui::Spacing();
    ImGui::Button("Wallhack", ImVec2(0.000f, 0.000f));
